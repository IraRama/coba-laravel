...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item <?php echo e(request()->is('siswa/beranda') ? 'active':''); ?>">
                <a class="nav-link" href="<?php echo e(url('siswa/beranda', [])); ?>">
            ...
            <li class="nav-item  <?php echo e(request()->is('siswa/kelas*') ? 'active':''); ?>">
                <a class="nav-link" href="<?php echo e(url('siswa/kelas', [])); ?>">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Kelas</span></a>
            </li>            
...
</html><?php /**PATH D:\belajar_laravel\unama-learning\resources\views/siswa/layout.blade.php ENDPATH**/ ?>
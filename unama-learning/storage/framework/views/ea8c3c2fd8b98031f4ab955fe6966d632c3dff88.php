...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item <?php echo e(request()->is('guru/beranda') ? 'active':''); ?>">
                <a class="nav-link" href="<?php echo e(url('guru/beranda', [])); ?>">
            ...
            <li class="nav-item  <?php echo e(request()->is('guru/kelas*') ? 'active':''); ?>">
                <a class="nav-link" href="<?php echo e(url('guru/kelas', [])); ?>">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Kelas</span></a>
            </li>
            <li class="nav-item  <?php echo e(request()->is('guru/materi*') ? 'active':''); ?>">
                <a class="nav-link" href="<?php echo e(url('guru/materi', [])); ?>">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Materi</span></a>
            </li>
...
</html><?php /**PATH D:\belajar_laravel\unama-learning\resources\views/guru/layout.blade.php ENDPATH**/ ?>